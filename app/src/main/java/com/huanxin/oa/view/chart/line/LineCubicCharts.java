...
public class LineCubicCharts extends FrameLayout {
    List<ChartBean> data;
    Context context;
    LineChart chart;
    XAxis xAxis;
    ...
    /*设置数据源*/
    public LineCubicCharts setData(List<ChartBean> data) {
        this.data = data;
        return this;
    }
    public void build() {
    ...
    /*设置y轴标签数*/
    public LineCubicCharts setYCount(int yCount) {
        this.yCount = yCount;
        return this;
    }
    ...
    public LineCubicCharts(@NonNull Context context) {
        this(context, null);
    }

    public LineCubicCharts(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
