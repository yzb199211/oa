package com.huanxin.oa.view.pick.view;
...
import com.huanxin.oa.view.pick.configure.PickerOptions;
import com.huanxin.oa.view.pick.listener.OnDismissListener;
import com.huanxin.oa.view.pick.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.pickerview, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.pickerview, mPickerOptions.decorView, false);
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.pick_dialog);
