...
public class FormMenusBean {
    ...
    private List<FormChildMenusBean> ChildMenus;
    ...
    public List<FormChildMenusBean> getChildMenus() {
        return ChildMenus;
    }

    public void setChildMenus(List<FormChildMenusBean> ChildMenus) {
